...
related:
  ...
  - "../tickets/ticket-09-list-mirror-api.md"
  - "../tickets/ticket-10-delete-confirmation.md"
  - "../tickets/ticket-11-store-category-address.md"
...
| T2 | List detail page — items, add/check/edit, product mapping, review flow | §2.16 Review flow | partial — add product to list (search + create new + price/quantity) done in [ticket-07](../tickets/ticket-07-add-product-to-list.md); check/delete items + price chip done in [ticket-08](../tickets/ticket-08-shopping-list-improvements.md); edit/review open |
| T3 | Purchase & lifecycle — finish list (date + `finalTotal`), statuses new/finished/archived, empty list w/ price, quick purchase | §2.2, §2.3, §2.4, §2.13, §2.15 | partial — manual add purchase (finish with final total + date) done in [ticket-23](../tickets/ticket-23-add-purchase.md); scan receipt, archive/reopen transitions, quick purchase open |
| T4 | Catalog — Categories tab (CRUD, hierarchy, color/emoji, income flag) | §5.1 | partial — display + create + edit/delete done in [ticket-02](../tickets/ticket-02-catalog-page.md) + [ticket-08](../tickets/ticket-08-shopping-list-improvements.md); delete confirmation done in [ticket-10](../tickets/ticket-10-delete-confirmation.md); per-tab fuzzy search + paged lists done in [ticket-14](../tickets/ticket-14-catalog-search-paging.md); undo open |
| T5 | Catalog — Stores tab (CRUD, merge duplicates) | §5.2 | partial — display + create + edit/delete done in [ticket-02](../tickets/ticket-02-catalog-page.md) + [ticket-08](../tickets/ticket-08-shopping-list-improvements.md); address + category chooser done in [ticket-11](../tickets/ticket-11-store-category-address.md); delete confirmation done in [ticket-10](../tickets/ticket-10-delete-confirmation.md); per-tab fuzzy search + paged lists done in [ticket-14](../tickets/ticket-14-catalog-search-paging.md); merge open |
